...
class Work extends Component {
  constructor(props) {
    ...
    this.workDetails = [
      ...
      {
        number: '04',
        projectName: 'Real Estate Rental Management',
        projectDesc: 'The real estate rental management app offers a comprehensive solution for renters and rentees, facilitating property listings and communication. It streamlines rental processes and enhances the efficiency of property management tasks.',
