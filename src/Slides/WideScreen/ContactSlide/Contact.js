  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/HashirHamid" />
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:Hashir.f01@gmail.com" />
          <SocialLogo imgURL={instaImg} alternate="Instagram" redirectURL="https://www.instagram.com/_hashirhamid/" />
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/hashir-hamid/" />
        </SocialMediaIcons>
      </Container>
    );
  }
